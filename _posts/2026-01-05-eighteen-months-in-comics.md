---
layout: post
title: "18 Months in Comics"
date: 2026-01-05
categories: storycraft
robots: noindex
---

# My Eighteen Months in Comics

Issue #1 of Jed MacKay's X-Men came out on July 10th, 2024. A week before that, in anticipation of getting back into this hobby, I had purchased the oversized X-Men #700, the end of the Krakoan age. Since then, I have pulled 78 titles (including miniseries, but excluding one-shots), dropped 46, and managed to reach the end of the run for only 16 titles (one of which is _The Horizon Experiment_, a series of five one-shots, the others being miniseries/maxiseries and 2 cancelled ongoing, _NYX_ (2024) and _Birds of Prey_(2023)). I stopped all pulls and purchases abruptly in early December of 2025 for various and personal reasons. The majority of this content was originally written on September 7, 2025 prior to me stopping all comic reading/collecting.
...
I just read Jason Aaron's _Batman: Offworld_. It is literally Batman traveling to space to fight a fleet of aliens who commit genocide and enslave other alien races. Batman. A human being. Traveling to space. To fight aliens. ARE YOU FUCKING KIDDING ME? How utterly absurdly unbelievable is this premise? But that is _EXACTLY_ what makes comic books amazing. It is that inherent absurdity. Premises that don't even fly in the most imaginative sci-fi and fantasy novels. And when you suspend your disbelief to the nth degree for comics, you get this incredibly stupid fun stories. (This may be the only version of Batman I truly enjoy).
...
Another way of looking at these mediums comparatively would be the COST of making them.
...
* A film: $25-$200M
* A novel: two to five years of an author's life. Let's say a "living wage" of $50,000/year (provided you don't live in fucking Vancouver or a metropolitan city). That's $250,000 approximately?

So now the comparison of expense creates a new layer.

| Medium | Time | Cost | $/m | Make | $/m |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Novel | 450m | $25 | 6¢/m |$250k|$520/m|
...
OK, so what are some _actual_ story lessons I got after reading 1,164 issues of comics since July 2024 (count based on tracked numbers up to end of August 2025)? (UPDATE: 1,873 total issues read by December 2025). Here are the major ones:

### OTAA - One Thing After Another

This has got to be the one thing that annoys me the most about bad/lazy/unthoughtful storytelling. OTAA is basically a plot for the plot's sake. It's not tied to character, it doesn't really drive home any CDA, it attempts to have emotional moments but they're unearned, it relies on a lot of the [exonarrative factors](https://os.jinnzhong.com/exonarrative-factors-in-story-critique) that lesser writers rely on (basically fan-service, or worse, what the writer _thought_ would get the fans going). But outside of those factors, some more storycraft specific errors...
...
* **Why is Character Doing X?** - I guess this is similar to lack of scene goal, but it's a good reframe for checking when something's wrong or broken. If you're reading a comic and you have no idea why they're doing something, and they're just traveling from one place to another, or beating up bad guys (because bad guys need to be beat up)... it's just ONE THING AFTER ANOTHER. And you can't just have the PROT keep saying, "we have to do X, I can't explain because there's no time". Because eventually, you're just worn out about a PROT who keeps doing stuff without any clear ARC or reason.
...
* This requires you to know the Character's Flaw (hence ARC) in order to PICK the most relevant, juiciest, and most potent parts of the PROCESS to drive the story forward while dimming/skimming/skipping the parts of the PROCESS that doesn't do that. Ultimately, it must COST the PROT something.
...
* PROT is punishing themselves for a tragedy in which they believe it was their fault and they somehow find out it's not their fault. They then come up with a METHOD of revenge that is epic, batshit insane, or unhinged. ANTG who ruined PROT's life really did.
...
* Villains are comically evil but not in a fun over-the-top way, but in an embarrassing trying-to-be serious way.
...
From the notebook: Why am I dropping this? Stories are solid, have social commentary. Art is beautiful. Have I succumbed to the bright shiny object syndrome with X? I know I wanted to cut certain pulls because of the high number of subs I have. But there are still reasons beyond that right? I think, it could be because I haven't CARED about the PROT so far. I never had an emotional moment. No frisson, no sympathy. There also hasn't been any interesting MECHs. The MECH is straightforward (and built into it years ago). It's a standing for prejudice (no this isn't X-Men). Problem is - the MECH isn't really explored FURTHER. I don't know how the MECH affects the in-world STAKES further for the characters, for the community. All the things that show up in relationship to the MECH are tropey. WE've seen this. Maybe if it dug deeper into the "little things" of daily life? I dunno.
...
* Most superhero comics have a simple PROG of a FIGHT. Could be a powerful villain, a team, or army. The ARC is in HOW the PROT deals with an internal thing, or HOW the TEAM figures out how to work together, overcome differences, use/leverage each other's skills in the best way.
...
## The Second Notebook (completed early December 2025)

Here are notes from the second Muji notebook, the B5 one, as mentioned above.

* Give PROT something to do when they reveal BKST, but also _WHY_ are they revealing BKST in the first place? Is it to recruit? Convince? Manipulate? Guilt? Seduce? Confess? Moment of vulnerability? Give them a clear PROG reason to reveal their backstory.
   * BAD: Expository, info-dump narration with no substance. Either stakes but no character integration to stakes... or stakes for character underdeveloped or nonexistence.
   * FIX: reveal hints of BKST (ghost, trauma, weight, gravitas) WHO ARE THEY? Make us care ASAP. COST/CONSEQUENCE: What's at risk if they fail?
* GOOD: A CLEAR VISION = MECH/CDA/ARC unity right away. ARC is...
   * Starting emotional state
   * What do they want? Why?
   * What happens if they don't get it? Both logistics and emotional.
   * Without this unity, you devolve into OTAA plots.
* DIALOGUE CRIMES
   * Reveal unnecessary BKST - no reason/motive, just motor mouth character?
   * State emotions on sleeve without context or situation (melodrama)
   * Setup/Punchlines clever for sake of being clever (doesn't add to PROG nor ARC)
   * Talking in unnatural cartoonish way (not ironic, overly dramatic, like old anime)
   * Feeding audience excess exposition.
* HOLLOW STORIES (UNEARNED EMOTIONAL STATES)
   * BBEG didn't gradually, incrementally increased tension and just shows up. OP, no prep time for heroes, no foreshadowing
   * PROTS didn't gradually, incrementally build the attack/defense (level up, learned new things, gained new powers, have ALLY/MNTR/LOVR help them grow/improved their ARC first).
* SCENE TEMPLATES (I have no idea what the original purpose of these templates are)
   * Decide than change mind
   * Recruit, ask why - reveal ARC
   * Question/Affirm - solidify stakes
   * Recruit - deny/accept
   * Introduce villain/their boss
   * Blames self for friends caught
   * Enemies bicker about one breaking rules
   * Investigate last known sighting
   * Allies fight about how things are handled

## WHAT NEEDS TO BE REVEALED 100% ASAP?

1. The problem/conflict (WANT, doesn't have to be the overall scene goal, can be a step, or microcosm of it that PROT is actively working on)
2. The RULES of said problem (COST/CNSQ of failure) 
3. The emotional stakes (Why PROT wants it) ESTK
4. WHY NOW? Urgency and TTBs
5. WHERE in the process is the highest tension?

## WHAT CAN BE REVEALED OVER TIME

1. The method (what PROT is doing to fix problem and/or get at scene goal)
2. The "real reason why" BKST -- but _only_ if it's plot relevant
3. What the "rules" mean and why it was set up that way, and how it got that way.
